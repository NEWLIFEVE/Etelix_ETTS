...
{       
    ...
    private function _setSummary($args)
    {
        ...
        $this->_phpExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('E6', $this->arrow($temp1, $intervals['wo1Day'], 'E6', true))
                    ->setCellValue('F6', $intervals['wo1Day'])
                    ->setCellValue('G6', $this->arrow($temp1, $intervals['wo1Week'], 'G6', true))
                    ...
                    ->setCellValue('E7', $this->arrow($temp1, $intervals['yo1Day'], 'E7', true))
                    ->setCellValue('F7', $intervals['yo1Day'])
                    ->setCellValue('G7', $this->arrow($temp1, $intervals['yo1Week'], 'G7', true))
                    ...
                    ->setCellValue('E8', $this->arrow($temp1, $intervals['ro1Day'], 'E8', true))
                    ->setCellValue('F8', $intervals['ro1Day'])
                    ->setCellValue('G8', $this->arrow($temp1, $intervals['ro1Week'], 'G8', true))
                    ...
                    ->setCellValue('E9', $this->arrow($temp1, $intervals['to1Day'], 'E9', true))
                    ->setCellValue('F9', $intervals['to1Day'])
                    ->setCellValue('G9', $this->arrow($temp1, $intervals['to1Week'], 'G9', true))
                    ...
                    ->setCellValue('E10', $this->arrow($temp1, $intervals['wc1Day'], 'E10', true))
                    ->setCellValue('F10', $intervals['wc1Day'])
                    ->setCellValue('G10', $this->arrow($temp1, $intervals['wc1Week'], 'G10', true))
                    ...
                    ->setCellValue('E11', $this->arrow($temp1, $intervals['yc1Day'], 'E11', true))
                    ->setCellValue('F11', $intervals['yc1Day'])
                    ->setCellValue('G11', $this->arrow($temp1, $intervals['yc1Week'], 'G11', true))
                    ...
                    ->setCellValue('E12', $this->arrow($temp1, $intervals['rc1Day'], 'E12', true))
                    ->setCellValue('F12', $intervals['rc1Day'])
                    ->setCellValue('G12', $this->arrow($temp1, $intervals['rc1Week'], 'G12', true))
                    ...
                    ->setCellValue('E13', $this->arrow($temp1, $intervals['tc1Day'], 'E13', true))
                    ->setCellValue('F13', $intervals['tc1Day'])
                    ->setCellValue('G13', $this->arrow($temp1, $intervals['tc1Week'], 'G13', true))
                    ...
                    ->setCellValue('E14', $this->arrow($temp1, $intervals['naW1Day'], 'E14', true))
                    ->setCellValue('F14', $intervals['naW1Day'])
                    ->setCellValue('G14', $this->arrow($temp1, $intervals['naW1Week'], 'G14', true))
                    ...
                    ->setCellValue('E15', $this->arrow($temp1, $intervals['naY1Day'], 'E15', true))
                    ->setCellValue('F15', $intervals['naY1Day'])
                    ->setCellValue('G15', $this->arrow($temp1, $intervals['naY1Week'], 'G15', true))
                    ...
                    ->setCellValue('E16', $this->arrow($temp1, $intervals['naR1Day'], 'E16', true))
                    ->setCellValue('F16', $intervals['naR1Day'])
                    ->setCellValue('G16', $this->arrow($temp1, $intervals['naR1Week'], 'G16', true))
                    ...
                    ->setCellValue('E17', $this->arrow($temp1, $intervals['tna1Day'], 'E17', true))
                    ->setCellValue('F17', $intervals['tna1Day'])
                    ->setCellValue('G17', $this->arrow($temp1, $intervals['tna1Week'], 'G17', true))
                    ...
                    ->setCellValue('E18', $this->arrow($temp1, $intervals['eW1Day'], 'E18', true))
                    ->setCellValue('F18', $intervals['eW1Day'])
                    ->setCellValue('G18', $this->arrow($temp1, $intervals['eW1Week'], 'G18', true))
                    ...
                    ->setCellValue('E19', $this->arrow($temp1, $intervals['eY1Day'], 'E19', true))
                    ->setCellValue('F19', $intervals['eY1Day'])
                    ->setCellValue('G19', $this->arrow($temp1, $intervals['eY1Week'], 'G19', true))
                    ...
                    ->setCellValue('E20', $this->arrow($temp1, $intervals['eR1Day'], 'E20', true))
                    ->setCellValue('F20', $intervals['eR1Day'])
                    ->setCellValue('G20', $this->arrow($temp1, $intervals['eR1Week'], 'G20', true))
                    ...
                    ->setCellValue('E21', $this->arrow($temp1, $intervals['te1Day'], 'E21', true))
                    ->setCellValue('F21', $intervals['te1Day'])
                    ->setCellValue('G21', $this->arrow($temp1, $intervals['te1Week'], 'G21', true))
     ...
     * @throws Exception
     */
    public function arrow($a, $b, $coordinate = false, $excel = false)
    {
        $a = (int) $a;
        $b = (int) $b;
