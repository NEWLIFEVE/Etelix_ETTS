	...
	protected function performAjaxValidation($model)
	{
        ...
        {   
            ...
            if ($model->save()) {
                ...
                $mailer->enviar($this->getBodyMail($model->id_ticket, Mail::getNameMails($model->id_ticket)), Mail::getNameMails($model->id_ticket), '', 'New answer');
            } else {
                echo 'false';
            }
        }
        ...
        public function getDescription($idTicket, $datos)
        {
