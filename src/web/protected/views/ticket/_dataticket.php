...
<div id=content_detail>
    <div class="grid fluid">
        <h3 class="ticket-information">
            ...
            <?php if ($datos->id_status != '2' && Yii::app()->user->checkAccess('escalar-tickets')): ?> 
        ...
        <div class="row">
            <div class="span5">
                ...
                <?php if ($datos->id_status != '2' && Yii::app()->user->checkAccess('operacion-interno-subadmin')): ?>
            ...
            <div class="span7">
                ...
                <?php if (Yii::app()->user->checkAccess('operacion-interno-subadmin')): ?>
