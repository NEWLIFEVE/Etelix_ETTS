    ...
    */
	...
	private function _fieldAdminForm($model){
            ...
            if (isset($_POST[CrugeUtil::config()->postNameMappings['CrugeField']])) {
                ...
                $sql = "INSERT INTO cruge_field" .
                       "(fieldname, longname, position, required, fieldtype, fieldsize, maxlength, showinreports, useregexp, useregexpmsg, predetvalue) " .
                       "VALUES " . 
                       "(:fieldname, :longname, :position, :required, :fieldtype, :fieldsize, :maxlength, :showinreports, :useregexp, :useregexpmsg, :predetvalue)";
                $comando = Yii::app()->db->createCommand($sql);
                $comando->bindParam(":fieldname", $_POST['CrugeField']['fieldname'], PDO::PARAM_STR);
                $comando->bindParam(":longname", $_POST['CrugeField']['longname'], PDO::PARAM_STR);
                $comando->bindParam(":position", $_POST['CrugeField']['position'], PDO::PARAM_INT);
                $comando->bindParam(":required", $_POST['CrugeField']['required'], PDO::PARAM_INT);
                $comando->bindParam(":fieldtype", $_POST['CrugeField']['fieldtype'], PDO::PARAM_INT);
                $comando->bindParam(":fieldsize", $_POST['CrugeField']['fieldsize'], PDO::PARAM_INT);
                $comando->bindParam(":maxlength", $_POST['CrugeField']['maxlength'], PDO::PARAM_INT);
                $comando->bindParam(":showinreports", $_POST['CrugeField']['showinreports'], PDO::PARAM_INT);
                $comando->bindParam(":useregexp", $_POST['CrugeField']['useregexp'], PDO::PARAM_STR);
                $comando->bindParam(":useregexpmsg", $_POST['CrugeField']['useregexpmsg'], PDO::PARAM_STR);
                $comando->bindParam(":predetvalue", $_POST['CrugeField']['predetvalue'], PDO::PARAM_STR);
